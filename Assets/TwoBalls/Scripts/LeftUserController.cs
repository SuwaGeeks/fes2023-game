...
public class LeftUserController : MonoBehaviour
{
    ...
    {
        /*レーン関連の値の初期化*/
            /*レーンの最大値はleftBall配列の長さから１を引いた数*/
        MaxLane = leftBall.Length - 1;
            /*ターゲットのレーンはleftBall配列の長さを2で割った数*/
        targetLane = leftBall.Length / 2;
    }
    ...
    void Update()
    {
        ...
        transform.rotation = leftBall[targetLane].rotation;
